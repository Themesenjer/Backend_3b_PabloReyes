...
export class CreatePedidoproductoTable1733715778600 implements MigrationInterface {
    name = 'CreatePedidoproductoTable1733715778600'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "pedido_producto" ("id" SERIAL NOT NULL, "pedidoid" integer NOT NULL, "prouctoid" integer NOT NULL, "cantidad" integer NOT NULL, "pedidoId" integer, "productoId" integer, CONSTRAINT "PK_97f69aaf286bdd82afbd487e4d5" PRIMARY KEY ("id"))`);
